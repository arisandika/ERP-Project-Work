        ...
        <tbody>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="<?php echo e($index % 2 ? 'row-bg' : ''); ?>">
                    ...
                    <td class="text-right">
                        IDR <?php echo e(number_format($price, 0, ',', '.')); ?>

                    </td>
                    <td class="text-right">
                        IDR <?php echo e(number_format($totalValuation, 0, ',', '.')); ?>
    ...
    <table class="summary-table">
        <tr>
            ...
            <td class="text-right" style="font-weight: bold; font-size: 13px;">
                IDR <?php echo e(number_format($grandTotalValuation, 0, ',', '.')); ?>
...
<?php /**PATH D:\Nurul Fauziah\Project Work\Nexicon\ERP-Project-Work\resources\views/pdf/stock-report.blade.php ENDPATH**/ ?>