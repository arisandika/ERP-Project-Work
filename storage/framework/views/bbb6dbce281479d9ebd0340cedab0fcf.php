                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->is_pinned): ?>
                                        <div class="absolute top-2 right-2">
                                            <div class="flex items-center justify-center w-6 h-6 rounded-full shadow-sm"
                                                style="background-color: <?php echo e($project->color ?? '#6B7280'); ?>;" title="Project Disematkan">
                ...
                <div class="relative">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="p-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->filteredProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button wire:click="selectProject(<?php echo e($project->id); ?>)" @click="open = false"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->is_pinned): ?>
                                        <div class="flex items-center justify-center w-5 h-5 rounded-full shrink-0"
                                            style="background-color: <?php echo e($project->color ?? '#6B7280'); ?>;" title="Disematkan">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->id === $selectedProject->id): ?>
                                        <svg class="flex-shrink-0 w-4 h-4" style="color: <?php echo e($project->color ?? '#3B82F6'); ?>;"
...
<?php $component->withAttributes([]); ?>
                ...
                <div class="w-full gantt-wrapper">
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            window.ganttState = window.ganttState || {
                initialized: false,
                currentProjectId: '<?php echo e($projectId); ?>'
            };

            function getGanttData() {
                return <?php echo json_encode($this->ganttData ?? ['data' => [], 'links' => []], 512) ?>;
            }
            ...
            document.addEventListener('livewire:navigated', function () {
                ...
                window.ganttState.currentProjectId = '<?php echo e($projectId); ?>';
...
<?php endif; ?><?php /**PATH C:\laragon\www\erp-app\resources\views\filament\pages\project\ticket-timeline.blade.php ENDPATH**/ ?>