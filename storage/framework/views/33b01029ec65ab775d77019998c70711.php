    ...
    <div class="px-4 py-6 mx-auto md:py-0 max-w-7xl lg:px-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center sm:py-6">
            <div class="flex-1 min-w-0">
                ...
                <h1 class="text-2xl font-bold text-black sm:text-3xl dark:text-white"><?php echo e($project->name); ?>
            ...
            <div
                ...
                <div class="flex items-center w-full">
                    ...
                    <div class="flex-1 ml-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <p
                                class="text-2xl font-bold <?php echo e($projectStats['progress_percentage'] >= 100 ? 'text-green-600 dark:text-green-400' : ($projectStats['progress_percentage'] >= 75 ? 'text-blue-600 dark:text-blue-400' : ($projectStats['progress_percentage'] >= 50 ? 'text-yellow-600 dark:text-yellow-400' : 'text-black dark:text-white'))); ?>">
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p
                            class="text-2xl font-bold <?php echo e($projectStats['remaining_days'] !== null && $projectStats['remaining_days'] < 0 ? 'text-red-600 dark:text-red-400' : 'text-black dark:text-white'); ?>">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
            <div class="space-y-6 lg:col-span-4 lg:sticky lg:top-24 h-fit">
                <div class="grid grid-cols-1 gap-6">
                    <!-- CUSTOMER INFO CARD -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder && $project->salesOrder->customer): ?>
                            <div class="overflow-hidden transition-colors shadow-sm ring-1 ring-border-light bg-secondary-light rounded-2xl dark:bg-secondary-dark dark:ring-border-dark">
                                ...
                                <div class="p-5 space-y-4">
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-black dark:text-white"><?php echo e($project->salesOrder->customer->name); ?></p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 line-clamp-2"><?php echo e($project->salesOrder->customer->address ?? 'Alamat tidak tersedia'); ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex flex-col gap-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="text-sm font-medium text-black dark:text-white"><?php echo e($project->salesOrder->customer->pic_name ?? '-'); ?></p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($project->salesOrder->customer->pic_position ?? 'Perwakilan Client'); ?></p>
                                                </div>
                                            </div>
                                            <!-- Contact Actions -->
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder->customer->pic_phone || $project->salesOrder->customer->email): ?>
                                            <div class="flex gap-2 mt-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder->customer->pic_phone): ?>
                                                    <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $project->salesOrder->customer->pic_phone))); ?>" target="_blank"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder->customer->email): ?>
                                                    <a href="mailto:<?php echo e($project->salesOrder->customer->email); ?>"
                        ...
                        <div class="overflow-hidden transition-colors shadow-sm ring-1 ring-border-light bg-secondary-light rounded-2xl dark:bg-secondary-dark dark:ring-border-dark">
                            ...
                            <div class="p-5 space-y-5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder && $project->salesOrder->employee): ?>
                                <div class="flex items-center gap-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder->employee->photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $project->salesOrder->employee->photo)); ?>" class="object-cover w-10 h-10 rounded-full ring-2 ring-white dark:ring-gray-800" alt="AM">
                                    <?php else: ?>
                                        <div class="flex items-center justify-center w-10 h-10 text-xs font-bold text-white rounded-full bg-main-primary ring-2 ring-white dark:ring-gray-800">
                                            <?php echo e(substr($project->salesOrder->employee->full_name, 0, 1)); ?>

                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-bold text-black truncate dark:text-white"><?php echo e($project->salesOrder->employee->full_name); ?></p>
                                        <p class="text-xs text-blue-600 dark:text-blue-400">Account Manager</p>
                                    </div>
                                    <!-- Call AM Button -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->salesOrder->employee->phone_number): ?>
                                    <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $project->salesOrder->employee->phone_number))); ?>" target="_blank" class="p-2 text-green-400 transition-colors hover:text-green-500">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->members->count() > 0): ?>
                                <div>
                                    <p class="mb-3 text-xs font-semibold tracking-wide text-gray-400 uppercase">Project Squad</p>
                                    <div class="flex -space-x-2 overflow-hidden">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $project->members->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->photo): ?>
                                                <img class="inline-block object-cover w-8 h-8 rounded-full ring-2 ring-white dark:ring-secondary-dark" src="<?php echo e(asset('storage/' . $member->photo)); ?>" alt="<?php echo e($member->full_name); ?>" title="<?php echo e($member->full_name); ?>">
                                            <?php else: ?>
                                                <div class="inline-flex items-center justify-center w-8 h-8 text-xs font-medium text-white bg-gray-400 rounded-full ring-2 ring-white dark:ring-secondary-dark" title="<?php echo e($member->full_name); ?>">
                                                    <?php echo e(substr($member->full_name, 0, 1)); ?>

                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->members->count() > 5): ?>
                                            <div class="inline-flex items-center justify-center w-8 h-8 text-xs font-medium text-white bg-gray-800 rounded-full ring-2 ring-white dark:ring-secondary-dark">
                                                +<?php echo e($project->members->count() - 5); ?>
                    ...
                    <div class="tab-content-container">
                        ...
                        <div id="tasks-tab" class="tab-content">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td class="p-4 text-sm text-black lg:px-6 dark:text-gray-300">
                                                    <div class="font-medium text-black dark:text-white"><?php echo e($ticket->name); ?></div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->tickets->hasPages()): ?>
                                <div class="px-6 mt-4 bg-secondary-light dark:bg-secondary-dark rounded-b-2xl custom-pagination"
                            ...
                            <div class="p-4 lg:p-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->recentActivities->count() > 0): ?>
                                    ...
                                    <div class="hidden p-4 md:block">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="relative">
                                                <!-- Dot -->
                                                <div
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-sm text-black dark:text-gray-200">
                                                        <span
                                                            class="font-semibold"><?php echo e($activity->ticket->name ?? 'Tugas'); ?></span>
                                                    ...
                                                    <span
                                                        class="text-xs text-gray-400"><?php echo e($activity->created_at->diffForHumans()); ?></span>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\erp-app-main\resources\views/livewire/external-dashboard.blade.php ENDPATH**/ ?>