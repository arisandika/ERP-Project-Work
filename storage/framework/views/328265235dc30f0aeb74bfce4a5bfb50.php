...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('heading', null, []); ?> 
        <h1
            class="mt-4 text-2xl font-bold tracking-tight text-center fi-simple-header-heading text-gray-950 dark:text-white">
            Nexicon ERP Login
        </h1>
     <?php $__env->endSlot(); ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
     ...
     <?php $__env->slot('subheading', null, []); ?> 
        <p class="mb-2 text-sm text-center text-gray-500 fi-simple-header-subheading dark:text-gray-400">Selamat
            datang! Masuk untuk mengelola bisnis Anda dengan mudah dan efisien.</p>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\erp-app\vendor\filament\filament\resources\views\pages\auth\login.blade.php ENDPATH**/ ?>