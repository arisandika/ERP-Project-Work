...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProject): ?>
        <div
            ...
            class="relative overflow-x-auto pb-6 <?php echo e(!$this->canMoveTickets() ? 'view-only-mode' : ''); ?>"
            id="board-container"
        >
            ...
            <div class="inline-flex min-w-full gap-4 pb-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->ticketStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center justify-between">
                                <h3 class="flex items-center gap-2 font-medium" style="color: white; text-shadow: 0px 0px 1px rgba(0,0,0,0.5);">
                                    ...
                                    <span class="text-sm opacity-80"><?php echo e($status->tickets->count()); ?></span>
                        ...
                        <div class="flex flex-col flex-1 gap-3 p-3 overflow-y-auto" style="max-height: calc(100% - 60px);" x-data="{ visibleTickets: 10, totalTickets: <?php echo e($status->tickets->count()); ?>, scrollPos: 0 }" x-init="$nextTick(() => { $el.addEventListener('scroll', () => { scrollPos = $el.scrollTop; if ($el.scrollTop + $el.clientHeight >= $el.scrollHeight - 100 && visibleTickets < totalTickets) { visibleTickets = Math.min(visibleTickets + 10, totalTickets); } }); })" x-ref="ticketContainer<?php echo e($status->id); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $status->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                >
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <div class="flex items-center gap-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->priority): ?>
                                                <span class="text-xs px-1.5 py-0.5 rounded whitespace-nowrap text-white font-medium" style="background-color: <?php echo e($ticket->priority->color); ?>;">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->due_date): ?>
                                                <span class="text-xs px-1.5 py-0.5 rounded whitespace-nowrap <?php echo e($ticket->due_date->isPast() ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' : 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300'); ?>">
                                                    <?php echo e($ticket->due_date->format('M d')); ?>
                                    ...
                                    <h4 class="mb-2 font-medium text-black dark:text-white"><?php echo e($ticket->name); ?></h4>
                                            ...
                                            <div class="flex flex-wrap gap-1 max-w-[180px]">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ticket->assignees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="inline-flex items-center gap-1 py-1 pl-1 pr-2 rounded-full bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-300">
                                                        ...
                                                        <span class="text-xs font-medium truncate"><?php echo e(\Illuminate\Support\Str::limit($assignee->full_name, 8)); ?></span>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->assignees->count() > 2): ?>
                                                    <!-- <div class="inline-flex items-center px-2 py-1 text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-gray-400">
                                                        <span class="text-xs font-medium">+<?php echo e($ticket->assignees->count() - 2); ?></span>
                                                    </div> -->
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /var/www/erp-app-main/resources/views/filament/pages/project/project-board-v1.blade.php ENDPATH**/ ?>