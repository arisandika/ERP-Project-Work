<div>
        ...
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative overflow-hidden border shadow-sm cursor-pointer group rounded-xl border-border-light dark:border-border-dark"
                    onclick="openVisitPhotoLightbox('<?php echo e($photo->url()); ?>', '<?php echo e(addslashes($photo->caption ?? '')); ?>', '<?php echo e($photo->taken_at?->format('d M Y H:i') ?? ''); ?>', '<?php echo e($photo->latitude ?? ''); ?>', '<?php echo e($photo->longitude ?? ''); ?>')">
                    
                    <img src="<?php echo e($photo->url()); ?>" alt="<?php echo e($photo->caption ?? 'Foto kunjungan'); ?>"
                    ...
                    <div class="absolute top-1.5 left-1.5">
                        <span class="text-[10px] font-semibold px-1.5 py-0.5 rounded-md
                                <?php echo e(match ($photo->photo_type) {
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photo->hasCoordinates()): ?>
                        <div class="absolute bottom-1.5 right-1.5">
                            <a href="<?php echo e($photo->googleMapsUrl()); ?>" target="_blank" rel="noopener noreferrer"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photo->caption): ?>
                        <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent px-2 pt-4 pb-1.5">
                            <p class="text-[11px] text-white line-clamp-1"><?php echo e($photo->caption); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
    ...
    <?php if (! $__env->hasRenderedOnce('eabbfbf7-fcc5-43e7-b4bc-b51e617f3940')): $__env->markAsRenderedOnce('eabbfbf7-fcc5-43e7-b4bc-b51e617f3940'); ?>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\erp-app-main\resources\views/filament/infolists/components/visit-photos.blade.php ENDPATH**/ ?>