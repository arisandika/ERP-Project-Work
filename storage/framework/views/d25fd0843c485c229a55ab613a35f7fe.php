...
<?php
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...
        match ($color) {
            'gray' => 'hover:bg-main-light focus-visible:bg-main-light dark:hover:bg-white/5 dark:focus-visible:bg-white/5',
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\laragon\www\erp-app-main\vendor\filament\support\resources\views/components/dropdown/list/item.blade.php ENDPATH**/ ?>