        ...
        <section class="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div class="grid grid-cols-1 gap-6 md:col-span-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasCheckedIn): ?>
                    <form action="<?php echo e(route('attendance.clockin')); ?>" method="POST" class="p-6 fi-section rounded-2xl ring-1"
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => '/hr/attendance-history','color' => 'gray']); ?>Lihat
...
<?php endif; ?><?php /**PATH D:\Nurul Fauziah\Project Work\Nexicon\ERP-Project-Work\resources\views/filament/pages/hr/attendance.blade.php ENDPATH**/ ?>