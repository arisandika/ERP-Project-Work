<div class="min-h-screen transition-colors duration-300 bg-gray-50 dark:bg-gray-950">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('message')): ?>
        <div class="fixed z-50 px-4 py-3 text-blue-600 bg-blue-100 rounded-md shadow-lg top-4 right-4" id="success-message">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
        <div class="fixed z-50 px-4 py-3 text-red-600 bg-red-100 rounded-md shadow-lg top-4 right-4" id="error-message">
            <div class="flex items-center space-x-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col gap-4 py-4 sm:flex-row sm:justify-between sm:items-center sm:py-6">
            <div class="flex-1 min-w-0">
                <h1 class="text-2xl font-bold text-gray-900 truncate sm:text-3xl dark:text-white"><?php echo e($project->name); ?>

                </h1>
                <p class="mt-1 text-sm text-gray-600 sm:text-base dark:text-gray-400">Nexicon - External Dashboard</p>
            </div>

            <div class="flex items-center flex-shrink-0 space-x-3 sm:space-x-4">
                <!-- Theme Toggle -->
                ...
                <button wire:click="refreshData" wire:loading.attr="disabled"
                    class="flex items-center px-3 py-2 space-x-1 text-sm font-medium text-white transition-colors duration-200 bg-blue-600 rounded-lg hover:bg-blue-700 disabled:bg-blue-400 sm:px-4 sm:space-x-2">
                ...
                <button wire:click="logout"
                    class="flex items-center px-3 py-2 space-x-1 text-sm font-medium text-white transition-colors duration-200 bg-red-600 rounded-lg hover:bg-red-700 sm:px-4 sm:space-x-2">
    ...
    <div class="px-4 py-8 mx-auto space-y-8 max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <!-- Card: Total Team -->
            <div
                class="p-6 transition-colors bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-900 dark:border-gray-800">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">
                            <?php echo e($projectStats['total_team'] ?? 0); ?>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 ml-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <p
                                class="text-2xl font-bold <?php echo e($projectStats['progress_percentage'] >= 100 ? 'text-green-600 dark:text-green-400' : ($projectStats['progress_percentage'] >= 75 ? 'text-blue-600 dark:text-blue-400' : ($projectStats['progress_percentage'] >= 50 ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-900 dark:text-white'))); ?>">
                                <?php echo e($projectStats['progress_percentage'] ?? 0); ?>%
                            </p>
                        </div>
                        <div class="w-full h-2 mt-2 bg-gray-200 rounded-full dark:bg-gray-700">
                            <div class="bg-gradient-to-r <?php echo e($projectStats['progress_percentage'] >= 100 ? 'from-green-400 to-green-600' : ($projectStats['progress_percentage'] >= 75 ? 'from-blue-400 to-blue-600' : ($projectStats['progress_percentage'] >= 50 ? 'from-yellow-400 to-yellow-600' : 'from-gray-400 to-gray-600'))); ?> h-2 rounded-full transition-all duration-300"
                                style="width: <?php echo e(min($projectStats['progress_percentage'] ?? 0, 100)); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p
                            class="text-2xl font-bold <?php echo e($projectStats['remaining_days'] !== null && $projectStats['remaining_days'] < 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'); ?>">
                            <?php echo e($projectStats['remaining_days'] ?? 'N/A'); ?>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">
                            <?php echo e($projectStats['total_tickets'] ?? 0); ?>
        ...
        <div class="transition-colors bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-900 dark:border-gray-800"
            id="dashboard-tabs">
        ...
        setActive(tab) {
                ...
                <div class="px-4 py-3 sm:hidden">
                    <div class="relative">
                        <button type="button" onclick="toggleMobileTabDropdown()"
                            class="w-full px-4 py-2 text-left bg-white border border-gray-300 rounded-md cursor-pointer dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div id="mobile-tab-dropdown"
                            class="absolute left-0 right-0 z-10 hidden mt-1 bg-white border border-gray-200 rounded-md shadow-lg dark:bg-gray-800 dark:border-gray-700">
                            <div class="py-1">
            ...
            <div class="tab-content-container">
                ...
                <div id="tasks-tab" class="tab-content">
                            ...
                            <div class="flex flex-col gap-3 md:flex-row">
                                ...
                                <div class="relative">
                                    <input type="text" wire:model.live.debounce.300ms="searchTerm"
                                        ...
                                        class="w-[300px] py-2 pl-10 pr-4 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg dark:text-white dark:bg-gray-800 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <div class="flex flex-col gap-3 sm:flex-row">
                                    ...
                                    <select wire:model.live="selectedStatus"
                                        class="w-[200px] flex-1 px-3 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg dark:text-white dark:bg-gray-800 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    ...
                                    <!-- Clear Filters -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedStatus || $searchTerm): ?>
                                        <button wire:click="clearFilters"
                                            onclick="setTimeout(() => switchTab(getCurrentTab()), 150)"
                                            class="px-4 py-2 text-sm text-gray-600 transition-colors duration-200 bg-white border border-gray-300 rounded-lg whitespace-nowrap hover:text-gray-800 hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-700">
                                            Clear Filters
                                        </button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                    ...
                    <!-- Table Container -->
                    <div class="mt-4 overflow-x-auto border-t border-gray-200 dark:border-gray-700">
                        <!-- Desktop Table -->
                        <table class="hidden min-w-full divide-y divide-gray-200 sm:table dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    <th
                                        class="p-4 text-xs font-medium tracking-wider text-left text-gray-500 uppercase lg:px-6 dark:text-gray-400">
                                        Code</th>
                                    <th
                                        class="p-4 text-xs font-medium tracking-wider text-left text-gray-500 uppercase lg:px-6 dark:text-gray-400">
                                        Task Name</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr
                                        class="transition-colors duration-150 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                        <td
                                            class="p-4 text-sm font-medium text-gray-900 rounded-lg whitespace-nowrap lg:px-6 dark:text-white">
                                            <?php echo e($ticket->uuid); ?>

                                        </td>
                                        <td class="p-4 text-sm text-gray-900 rounded-lg lg:px-6 dark:text-gray-300">
                                            <div class="font-medium text-gray-900 dark:text-white"><?php echo e($ticket->name); ?></div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->description): ?>
                                                <div class="max-w-xs mt-1 text-xs text-gray-500 truncate dark:text-gray-400">
                                                    <?php echo e(strip_tags(Str::limit($ticket->description, 100))); ?>

                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td
                                            class="p-4 text-sm text-gray-900 rounded-lg whitespace-nowrap lg:px-6 dark:text-gray-300">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->due_date): ?>
                                                <span
                                                    class="<?php echo e(\Carbon\Carbon::parse($ticket->due_date)->isPast() ? 'text-red-600 dark:text-red-400 font-medium' : ''); ?>">
                                                    <?php echo e(\Carbon\Carbon::parse($ticket->due_date)->format('M d, Y')); ?>

                                                </span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Carbon\Carbon::parse($ticket->due_date)->isPast()): ?>
                                        ...
                                        <td class="p-4 rounded-lg whitespace-nowrap lg:px-6">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-white"
                                                style="background-color: <?php echo e($ticket->status->color ?? '#6B7280'); ?>">
                                                <?php echo e($ticket->status->name ?? 'Unknown'); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="4" class="px-4 py-12 text-center lg:px-6">
                        ...
                        <div class="sm:hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div
                                    class="p-4 transition-colors duration-150 border-b border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800/50">
                                    <div class="space-y-3">
                                        <!-- Header Row -->
                                        ...
                                        <div class="flex items-center text-sm">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->due_date): ?>
                                                <span
                                                    class="<?php echo e(\Carbon\Carbon::parse($ticket->due_date)->isPast() ? 'text-red-600 dark:text-red-400 font-medium' : 'text-gray-600 dark:text-gray-400'); ?>">
                                                    Due:
                                                    <?php echo e(\Carbon\Carbon::parse($ticket->due_date)->format('M d, Y')); ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="p-8 text-center">
                                    ...
                                    <p class="text-lg font-medium text-gray-900 dark:text-white">No tasks found</p>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->tickets->hasPages()): ?>
                        <div class="p-4 border-t border-gray-200 lg:px-6 dark:border-gray-700"
                ...
                <div id="activity-tab" class="hidden tab-content">
                    <div class="p-4 border-b border-gray-200 lg:px-6 dark:border-gray-700">
                        <div>
                    ...
                    <div class="p-4 lg:p-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->recentActivities->count() > 0): ?>
                            <!-- Desktop Activity List -->
                            <div class="hidden space-y-4 sm:block">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        class="flex items-start p-3 space-x-3 transition-colors duration-150 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm text-gray-900 dark:text-gray-200">
                                                <span
                                                    class="font-medium text-gray-900 dark:text-white"><?php echo e($activity->ticket->name ?? 'Unknown Task'); ?></span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity->status): ?>
                                                    moved to <span class="font-medium"
                                                        style="color: <?php echo e($activity->status->color ?? '#6B7280'); ?>"><?php echo e($activity->status->name); ?></span>
                                                <?php else: ?>
                                                    was updated
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </p>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="flex items-start space-x-3">
                                            <div class="flex-shrink-0">
                                                <div
                                                    class="flex items-center justify-center w-6 h-6 bg-gray-100 rounded-full dark:bg-gray-700">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium leading-tight text-gray-900 dark:text-white">
                                                    <?php echo e($activity->ticket->name ?? 'Unknown Task'); ?>

                                                </p>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity->status): ?>
                                                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                                        Moved to <span class="font-medium px-2 py-0.5 rounded text-xs text-white"
                                                            style="background-color: <?php echo e($activity->status->color ?? '#6B7280'); ?>"><?php echo e($activity->status->name); ?></span>
                                                    </p>
                                                <?php else: ?>
                                                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Task was updated</p>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php else: ?>
                            <div class="py-12 text-center">
                                <svg class="w-12 h-12 mx-auto mb-4 text-gray-400 dark:text-gray-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                                </svg>
                                <div>
                                    <p class="text-lg font-medium text-gray-900 dark:text-white">No recent activity</p>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Activities will appear here when
                                        tasks are updated
                                    </p>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\erp-app\resources\views\livewire\external-dashboard.blade.php ENDPATH**/ ?>