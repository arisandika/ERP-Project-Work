    ...
    <div class="totals-section">
        ...
        <table class="totals-table">
            <tr>
                ...
                <td class="amount">Rp <?php echo e(number_format($invoice->subtotal, 0, ',', '.')); ?></td>
            </tr>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->discount > 0): ?>
                <tr>
                    ...
                    <td class="amount" style="color: #c00;">
                        ...
                        - Rp <?php echo e(number_format($discAmount, 0, ',', '.')); ?>
            ...
            <tr class="grand-total-row">
                ...
                <td class="amount">Rp <?php echo e(number_format($invoice->grand_total, 0, ',', '.')); ?></td>
            </tr>
        </table>
    </div>
...
</html><?php /**PATH C:\laragon\www\erp-app\resources\views\pdf\invoice.blade.php ENDPATH**/ ?>