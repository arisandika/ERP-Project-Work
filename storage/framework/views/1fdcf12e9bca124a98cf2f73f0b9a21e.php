                    ...
                    <div wire:key="stage-column-<?php echo e($stage->id); ?>"
                        ...
                        <div
                            ...
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                Rp <?php echo e(number_format($stage->deals->sum('estimated_value'), 0, ',', '.')); ?>
                        ...
                        <div class="flex flex-col flex-1 gap-3 p-3 overflow-y-auto no-scrollbar rounded-b-xl"
                            ...
                            x-ref="dealContainer<?php echo e($stage->id); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stage->deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div wire:key="deal-<?php echo e($stage->id); ?>-<?php echo e($deal->id); ?>"
                                    class="relative p-3 bg-secondary-light border border-l-4 border-border-light rounded-2xl cursor-move deal-card dark:bg-secondary-dark dark:border-border-dark <?php echo e($borderColor); ?>"
                                    ...
                                    <h4 class="mb-1 text-[15px] font-semibold text-black dark:text-white line-clamp-2">
                                        <?php echo e($deal->customer?->name ?? $deal->lead?->name ?? 'Unknown Client'); ?>

                                    </h4>

                                    <div class="mb-2 text-lg font-bold <?php echo e($valueColor); ?>">
                                    ...
                                    <div class="flex items-center gap-2 mb-3 text-xs whitespace-nowrap">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($start): ?>
...
<?php endif; ?>
                                            ...
                                            <?php echo e($isOverdue ? 'text-red-600 dark:text-red-400 font-medium' : 'text-gray-500 dark:text-gray-400 font-medium'); ?>"
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                                    <?php echo e($start->format('d M y')); ?> - Open
                                                </span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center flex-shrink-0 gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deal->quotations && $deal->quotations->isNotEmpty()): ?>
                                                                ...
                                                                <a href="<?php echo e(\App\Filament\Resources\Sales\QuotationResource::getUrl('edit', ['record' => $quotation->id])); ?>"
                                                                    ...
                                                                    <div class="flex items-center justify-between mb-1">
                                                                        <span
                                                                            ...
                                                                            title="<?php echo e($quotation->quotation_number); ?>">
                                                                        ...
                                                                        ?>
                                                                        <span
                                                                            class="text-[9px] font-semibold px-1.5 py-0.5 rounded-md tracking-wider capitalize <?php echo e($statusColor); ?>">
                                                                            <?php echo e($quotation->status); ?>

                                                                        </span>
                                                                    </div>
                                                                    <div class="text-xs font-medium text-gray-500 dark:text-gray-400">
                                                                        Rp <?php echo e(number_format($quotation->grand_total, 0, ',', '.')); ?>
