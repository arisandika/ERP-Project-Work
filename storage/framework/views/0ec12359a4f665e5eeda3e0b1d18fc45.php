                    ...
                    <header class="flex flex-col items-center fi-simple-header">
                        <div style="height: 1.5rem;" class="flex mb-8 fi-logo">
                            <div class="flex items-center">
                                ...
                                <img src="<?php echo e(asset('assets/logo-light.webp')); ?>" alt="Logo"
                        ...
                        <div
                            ...
                            <div class="flex flex-col items-center justify-center gap-2">
                                <span class="text-xs font-medium tracking-wide uppercase text-main-primary">Nomor
                                    Invoice</span>
                                <div class="text-base font-bold text-black dark:text-white"><?php echo e($invoiceNumber); ?>
...
</html><?php /**PATH /var/www/erp-app-main/resources/views/invoice/verify.blade.php ENDPATH**/ ?>