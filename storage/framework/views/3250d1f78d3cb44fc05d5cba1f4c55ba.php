...
# Purchase Order: <?php echo new \Illuminate\Support\EncodedHtmlString($purchaseOrder->po_number); ?>


Kepada Yth. <?php echo new \Illuminate\Support\EncodedHtmlString($purchaseOrder->supplier?->name ?? 'Supplier'); ?>,

Bersama email ini, kami lampirkan dokumen Purchase Order (PO) dengan nomor **<?php echo new \Illuminate\Support\EncodedHtmlString($purchaseOrder->po_number); ?>**.
...
<?php endif; ?>
<?php /**PATH D:\Nurul Fauziah\Project Work\Nexicon\ERP-Project-Work\resources\views/emails/procurement/purchase-order-body.blade.php ENDPATH**/ ?>