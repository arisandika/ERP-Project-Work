...
<?php endif; ?>
        ...
        <div class="mb-4" x-data="{ open: false }">
            <div class="relative">
                <button
                    ...
                    style="border-color: <?php echo e($selectedProject->color ?? '#D1D5DB'); ?>;"
                >
                    ...
                    <div class="p-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->filteredProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                wire:click="selectProject(<?php echo e($project->id); ?>)"
                                @click="open = false"
                                class="w-full flex items-center gap-3 px-3 py-2 rounded-md hover:bg-main-light dark:hover:bg-gray-700 transition-colors text-left <?php echo e($project->id === $selectedProject->id ? 'bg-main-light dark:bg-gray-700' : ''); ?>"
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->ticket_prefix): ?>
                                    <?php
                                        $color = $project->color ?? '#6B7280';
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->id === $selectedProject->id): ?>
                                    <svg class="flex-shrink-0 w-4 h-4" style="color: <?php echo e($project->color ?? '#3B82F6'); ?>;" fill="currentColor" viewBox="0 0 20 20">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedProject): ?>
        <div
            wire:key="board-container-<?php echo e($selectedProject->id); ?>"
            class="no-scrollbar relative overflow-x-auto pb-6 <?php echo e(!$this->canMoveTickets() ? 'view-only-mode' : ''); ?>"
            id="board-container"
        >
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$this->canMoveTickets()): ?>
            ...
            <div class="inline-flex min-w-full gap-4 pb-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->ticketStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        wire:key="status-<?php echo e($status->id); ?>"
                    ...
                    >
                        <div
                            ...
                            style="background-color: <?php echo e($status->color ?? '#f3f4f6'); ?>;"
                        >
                            <div class="flex items-center justify-between">
                                <h3 class="flex items-center gap-3 font-medium" style="color: white; text-shadow: 0px 0px 1px rgba(0,0,0,0.5);">
                                    ...
                                    <span class="inline-flex items-center justify-center flex-shrink-0 w-6 h-6 text-xs font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-lg dark:text-gray-50 dark:bg-gray-700 dark:border-gray-600"><?php echo e($status->tickets->count()); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status->is_completed): ?>
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    >
                                        <div class="p-2">
                                            ...
                                            <div class="py-1">
                                                <button
                                                    wire:click="setSortOrder(<?php echo e($status->id); ?>, 'date_created_newest')"
                                                    @click="open = false"
                                                ...
                                                <button
                                                    wire:click="setSortOrder(<?php echo e($status->id); ?>, 'date_created_oldest')"
                                                    @click="open = false"
                                                    class="w-full px-3 py-2 text-sm text-left text-gray-700 rounded dark:text-white"
                                                >
                                                ...
                                                <button
                                                    wire:click="setSortOrder(<?php echo e($status->id); ?>, 'card_name_alphabetical')"
                                                    @click="open = false"
                                                    class="w-full px-3 py-2 text-sm text-left text-gray-700 rounded dark:text-white"
                                                >
                                                ...
                                                <button
                                                    wire:click="setSortOrder(<?php echo e($status->id); ?>, 'due_date')"
                                                    @click="open = false"
                                                    class="w-full px-3 py-2 text-sm text-left text-gray-700 rounded dark:text-white"
                                                >
                                                    Due date
                                                ...
                                                <button
                                                    wire:click="setSortOrder(<?php echo e($status->id); ?>, 'priority')"
                                                    @click="open = false"
                                                    class="w-full px-3 py-2 text-sm text-left text-gray-700 rounded dark:text-white"
                                                >
                                                    Priority
                        ...
                        <div class="flex flex-col flex-1 gap-4 p-3 overflow-y-auto no-scrollbar" style="max-height: calc(100% - 60px);" x-data="{ visibleTickets: 10, totalTickets: <?php echo e($status->tickets->count()); ?>, scrollPos: 0 }" x-init="$nextTick(() => { $el.addEventListener('scroll', () => { scrollPos = $el.scrollTop; if ($el.scrollTop + $el.clientHeight >= $el.scrollHeight - 100 && visibleTickets < totalTickets) { visibleTickets = Math.min(visibleTickets + 10, totalTickets); } }); })" x-ref="ticketContainer<?php echo e($status->id); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $status->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    wire:key="ticket-<?php echo e($ticket->id); ?>-status-<?php echo e($status->id); ?>"
                                    ...
                                    x-show="<?php echo e($index); ?> < visibleTickets"
                                    style="border-left: 4px solid <?php echo e($ticket->priority->color); ?>;"
                                ...
                                >
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->due_date): ?>
                                            <span class="inline-flex items-center text-xs whitespace-nowrap <?php echo e($ticket->due_date->isPast() ? 'text-red-800 dark:text-red-300' : 'text-blue-800 dark:text-blue-300'); ?>">
...
<?php endif; ?>
                                                <?php echo e($ticket->due_date->format('d M y')); ?>

                                            </span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>

                                    <h4 class="mb-2 text-[15px] font-medium text-black dark:text-white"><?php echo e($ticket->name); ?></h4>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->description): ?>
                                        <p class="mb-3 text-sm text-gray-500 dark:text-gray-400 line-clamp-2">
                                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($ticket->description), 100)); ?>
                                            ...
                                            <div class="relative flex-1 min-w-0" x-data="{ open: false }">
                                                ...
                                                >
                                                    <div class="flex items-center gap-2 overflow-hidden">
                                                        <div class="flex-shrink-0 w-2 h-2 rounded-full shadow-sm" style="background-color: <?php echo e($status->color ?? '#9CA3AF'); ?>;"></div>
                                                        <span class="truncate"><?php echo e($status->name); ?></span>
                                                    </div>
                                                ...
                                                >
                                                    <div class="p-1">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->ticketStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <button
                                                                type="button"
                                                                wire:click="moveTicket(<?php echo e($ticket->id); ?>, <?php echo e($statusOption->id); ?>)"
                                                                @click="open = false"
                                                                class="flex items-center w-full gap-2 px-3 py-2 text-sm text-left rounded-md transition-colors group
                                                                <?php echo e($statusOption->id === $status->id 
                                                                    ? 'bg-primary-50 text-primary-700 dark:bg-primary-900/20 dark:text-primary-400 font-semibold' 
                                                                    : 'text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700'); ?>"
                                                            >
                                                                <div class="flex-shrink-0 w-2 h-2 rounded-full" style="background-color: <?php echo e($statusOption->color ?? '#9CA3AF'); ?>;"></div>
                                                                <span class="truncate"><?php echo e($statusOption->name); ?></span>
                                                                
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusOption->id === $status->id): ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->assignees->isNotEmpty()): ?>
                                                <div class="relative" x-data="{ open: false }">
                                                    <button
                                                        ...
                                                        title="View all <?php echo e($ticket->assignees->count()); ?> assignees"
                                                    >
                                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                                    ...
                                                    >
                                                        <div class="px-2 py-1.5 mb-2 text-xs font-semibold tracking-wider text-gray-500 uppercase border-b dark:text-gray-400 dark:border-gray-700">
                                                            <?php echo e($ticket->assignees->count()); ?> Assignees
                                                        </div>
                                                        
                                                        <div class="flex flex-col gap-1 overflow-y-auto max-h-48 custom-scrollbar">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ticket->assignees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-main-light dark:hover:bg-gray-700">
                                                                    <span class="flex items-center justify-center flex-shrink-0 w-6 h-6 text-xs text-white rounded-full bg-primary-500">
                                                                        <?php echo e(substr($assignee->full_name, 0, 1)); ?>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->creator): ?> 
                                                            ...
                                                            <div class="flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-main-light dark:hover:bg-gray-700">
                                                                <span class="flex items-center justify-center flex-shrink-0 w-6 h-6 text-xs text-white rounded-full bg-slate-500">
                                                                    <?php echo e(substr($ticket->creator->full_name ?? 'Admin', 0, 1)); ?>

                                                                </span>
                                                                <span class="text-sm font-medium text-gray-700 truncate dark:text-gray-200">
                                                                    <?php echo e($ticket->creator->full_name ?? 'Admin'); ?>
                                            ...
                                            <a
                                                href="<?php echo e(\App\Filament\Resources\Project\TicketResource::getUrl('edit', ['record' => $ticket->id])); ?>"
                                                target="_blank"
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status->tickets->isEmpty()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->ticketStatuses->isEmpty()): ?>
...
<?php endif; ?><?php /**PATH /var/www/erp-app-main/resources/views/filament/pages/project/project-board-v2.blade.php ENDPATH**/ ?>