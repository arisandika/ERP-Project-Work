...
<?php $component->withAttributes([]); ?>
    <div class="grid flex-1 auto-cols-fr gap-y-6">
        ...
        <div
            ...
            class="no-scrollbar relative overflow-x-auto pb-6 <?php echo e(!$this->canMoveDeals() ? 'view-only-mode' : ''); ?>"
            id="board-container">
                    ...
                    <div wire:key="stage-column-<?php echo e($stage->id); ?>"
                        ...
                        <div class="flex-shrink-0 px-4 py-3 border-b border-border-light bg-secondary-light rounded-t-xl dark:border-border-dark dark:bg-secondary-dark">
                                    ...
                                    <div x-show="open"
                                        ...
                                        <div class="p-2">
                                            ...
                                            <div class="py-1">
                                                ...
                                                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sortKey => $sortLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <button wire:click="setSortOrder(<?php echo e($stage->id); ?>, '<?php echo e($sortKey); ?>')" @click="open = false"
                            ...
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                Rp <?php echo e(number_format($stage->deals_total_value, 0, ',', '.')); ?>
                                ...
                                <div class="flex items-center gap-1 mt-2">
                                    <div class="w-full h-1.5 bg-accent-light rounded-full dark:bg-accent-dark">
                                        <div class="h-1.5 rounded-full"
                                            style="width: <?php echo e($stage->probability); ?>%; background-color: <?php echo e($stage->probability < 33 ? 'rgb(239, 68, 68)' : ($stage->probability < 66 ? 'rgb(245, 158, 11)' : 'rgb(34, 197, 94)')); ?>;">
                                        </div>
                                    </div>
                                    <span class="text-xs"><?php echo e($stage->probability); ?>%</span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="flex flex-col flex-1 gap-3 p-3 overflow-y-auto no-scrollbar rounded-b-xl"
                            ...
                            x-data="{ visibleDeals: 10, totalDeals: <?php echo e($stage->deals_count); ?> }"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stage->deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div wire:key="deal-<?php echo e($stage->id); ?>-<?php echo e($deal->id); ?>"
                                    class="relative p-3 bg-secondary-light border border-l-4 border-border-light rounded-2xl cursor-move deal-card dark:bg-secondary-dark dark:border-border-dark <?php echo e($stageBorderColor); ?>"
                                    data-deal-id="<?php echo e($deal->id); ?>"
                                    x-show="<?php echo e($index); ?> < visibleDeals"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dateRange): ?>
                                        <div class="flex items-center gap-2 mb-3 text-xs whitespace-nowrap">
                                            <span class="inline-flex items-center font-medium <?php echo e($end ? 'text-gray-500 dark:text-gray-400' : ($isOverdue ? 'text-orange-600 dark:text-orange-400' : 'text-gray-500 dark:text-gray-400')); ?>"
                                                title="<?php echo e($end ? 'Deal Closed' : 'Deal Still Open'); ?>">
...
<?php endif; ?>
                                    ...
                                    <div class="text-base font-bold <?php echo e($stageValueColor); ?>">
                                        Rp <?php echo e(number_format($deal->estimated_value, 0, ',', '.')); ?>
                                    ...
                                    <div class="flex items-center justify-between gap-3 pt-3 mt-4 border-t border-gray-300 dark:border-border-dark">
                                            ...
                                            <div class="relative flex-1 min-w-0" x-data="{ open: false }">
                                                ...
                                                <div x-show="open"
                                                    ...
                                                    <div class="p-1">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->dealStagesForSelect; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stageOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <button type="button"
                                        ...
                                        <div class="flex items-center flex-shrink-0 gap-2">
                                            <button 
                                                wire:click="mountAction('manageQuotations', { dealId: <?php echo e($deal->id); ?> })"
                                                type="button"
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deal->quotations->count() > 0): ?>
                                                    <span class="absolute top-0 right-0 flex items-center justify-center w-3.5 h-3.5 text-[10px] font-bold text-white bg-red-500 rounded-full transform translate-x-1/4 -translate-y-1/4">
                                                        <?php echo e($deal->quotations->count()); ?>

                                                    </span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </button>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->can('create_sales::activity::visit::assignment') && $deal->status !== 'lost'): ?>
                                                <button
                                                    
                                                    wire:click="mountAction('manageVisits', { dealId: <?php echo e($deal->id); ?> })"
                                                    type="button"
...
<?php endif; ?>
                                            ...
                                            <a href="<?php echo e(\App\Filament\Resources\CRM\DealResource::getUrl('view', ['record' => $deal->id])); ?>"
...
<?php endif; ?><?php /**PATH /home/nitro/projects/erp-app-main/resources/views/filament/pages/crm/deal-pipeline.blade.php ENDPATH**/ ?>