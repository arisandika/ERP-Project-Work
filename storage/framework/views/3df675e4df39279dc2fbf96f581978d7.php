                        ...
                        <div
                            ...
                            <div class="space-y-4 text-sm">
                                <div
                                    ...
                                    <span
                                        class="font-bold text-black break-all dark:text-white"><?php echo e($invoice->invoice_number); ?></span>
                                </div>
                                ...
                                <div
                                    ...
                                    <span
                                        class="font-semibold text-right text-black dark:text-white"><?php echo e($invoice->customer->name ?? '-'); ?></span>
                                </div>
                                ...
                                <div
                                    ...
                                    <span class="px-2.5 py-0.5 rounded-md text-xs font-semibold <?php echo e($statusClass); ?>">
                                ...
                                <div class="flex items-center justify-between pt-1">
                                    ...
                                    <span class="text-lg font-bold text-main-primary">
                                        IDR <?php echo e(number_format((float) $invoice->grand_total, 0, ',', '.')); ?>
...
</html><?php /**PATH /var/www/erp-app-main/resources/views/invoice/detail.blade.php ENDPATH**/ ?>