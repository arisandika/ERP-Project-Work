<div class="space-y-4" x-data="{
    ...
    <div>
        ...
        <span
            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($isActive ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'); ?>">
...
</div><?php /**PATH C:\laragon\www\erp-app\resources\views\filament\components\external-access-modal.blade.php ENDPATH**/ ?>