        ...
        <div class="max-w-4xl mx-auto text-sm md:text-base tabular-nums">
            ...
            <div class="flex justify-between items-center py-3 px-4 mb-8 bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-400 font-bold text-lg rounded-r-lg">
                ...
                <div class="w-48 flex justify-between text-gray-900 dark:text-white">
                    ...
                    <span><?php echo e(number_format($openingBalance, 0, ',', '.')); ?></span>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cashInflows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex justify-between py-1.5 px-2 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition rounded">
                            <span class="text-gray-700 dark:text-gray-300 pl-4"><?php echo e($category ?: 'Pemasukan Lain-lain'); ?></span>
                ...
                <div class="flex justify-between py-2 px-2 mt-3 border-t border-gray-300 dark:border-gray-700 font-bold text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-800/50 rounded-sm">
                    ...
                    <div class="w-48 flex justify-between">
                        <span class="text-gray-400">Rp</span>
                        <span class="text-success-600 dark:text-success-500"><?php echo e(number_format($totalInflow, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cashOutflows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex justify-between py-1.5 px-2 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition rounded">
                            <span class="text-gray-700 dark:text-gray-300 pl-4"><?php echo e($category ?: 'Pengeluaran Lain-lain'); ?></span>
                            <div class="w-48 flex justify-between font-medium text-gray-900 dark:text-gray-100">
                                <span class="text-gray-400">Rp</span>
                                <span><?php echo e(number_format($items->sum('amount'), 0, ',', '.')); ?></span>
                            </div>
                ...
                <div class="flex justify-between py-2 px-2 mt-3 border-t border-gray-300 dark:border-gray-700 font-bold text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-800/50 rounded-sm">
                    ...
                    <div class="w-48 flex justify-between">
                        <span class="text-gray-400">Rp</span>
                        <span class="text-danger-600 dark:text-danger-500">(<?php echo e(number_format($totalOutflow, 0, ',', '.')); ?>)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center py-3 px-4 mt-8 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 font-bold text-lg rounded-lg">
                ...
                <div class="w-48 flex justify-between <?php echo e($netCashFlow >= 0 ? 'text-success-600 dark:text-success-400' : 'text-danger-600 dark:text-danger-400'); ?>">
                    <span class="opacity-60">Rp</span>
                    <span><?php echo e($netCashFlow < 0 ? '(' : ''); ?><?php echo e(number_format(abs($netCashFlow), 0, ',', '.')); ?><?php echo e($netCashFlow < 0 ? ')' : ''); ?></span>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center py-4 px-2 mt-6 border-t-2 border-b-4 border-double border-gray-900 dark:border-white font-black text-xl md:text-2xl text-gray-900 dark:text-white">
                ...
                <div class="w-56 flex justify-between <?php echo e($endingBalance >= 0 ? 'text-primary-600 dark:text-primary-500' : 'text-danger-600 dark:text-danger-500'); ?>">
                    <span class="opacity-50">Rp</span>
                    <span><?php echo e($endingBalance < 0 ? '(' : ''); ?><?php echo e(number_format(abs($endingBalance), 0, ',', '.')); ?><?php echo e($endingBalance < 0 ? ')' : ''); ?></span>
                </div>
            </div>
