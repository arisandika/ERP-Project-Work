...
<head>
    ...
    <title>Verifikasi Invoice - <?php echo e(config('app.name')); ?></title>
                        ...
                        <div
                            ...
                            <div class="flex flex-col items-center justify-center gap-2">
                                <span
                                    ...
                                    Invoice</span>
                                <div class="text-base font-bold text-gray-900 dark:text-white"><?php echo e($invoiceNumber); ?>

                                </div>
                            </div>
                        </div>

                        <form method="POST" action="<?php echo e(route('invoice.verify.submit', ['number' => $invoiceNumber])); ?>"
                            ...
                            <div class="fi-fo-field-wrp">
                                        ...
                                        <div
                                            ...
                                            <div class="flex-1 min-w-0 fi-input-wrp-input">
                                                <input type="text" id="phone_last_4" name="phone_last_4"
                                                    value="<?php echo e(old('phone_last_4')); ?>" required maxlength="4"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['phone_last_4'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="mt-2 text-sm text-center text-red-600 dark:text-red-400"><?php echo e($message); ?></p>
                                <?php unset($message);
...
</html><?php /**PATH C:\laragon\www\erp-app\resources\views\invoice\verify.blade.php ENDPATH**/ ?>