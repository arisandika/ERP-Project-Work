...
#sc-wrap-<?php echo e($getId()); ?> video {
    width: 100% !important;
...
<div
    x-data="{
        ...
        async startScan() {
            const videoEl = document.getElementById('zxvid-<?php echo e($getId()); ?>');
            if (!videoEl) {
                this.isScanning = false;
                this.isLoading  = false;
                return;
...
<?php endif; ?><?php /**PATH D:\Nurul Fauziah\Project Work\Nexicon\ERP-Project-Work\resources\views/filament/forms/components/camera-scanner.blade.php ENDPATH**/ ?>