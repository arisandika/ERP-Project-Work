...
<body>
    ...
    <div class="document-title">
        <h1>SURAT JALAN</h1>
        <p>No: <?php echo e($do->do_number); ?></p>
    </div>
        ...
        <tr>
            ...
            <td style="width: 55%; padding-right: 20px;">
                ...
                <div class="client-box">
                    <strong
                        style="font-size: 13px; text-transform: uppercase;"><?php echo e($record->customer->name ?? 'UMUM'); ?></strong><br>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $record->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->item_desc): ?> <br><small style="color:#666"><?php echo e($item->item_desc); ?></small> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    ...
                    <td class="text-center" style="font-weight: bold;">
                        <?php echo e(number_format($item->qty_delivered, 0, ',', '.')); ?></td>
                </tr>
    ...
    <table class="signature-table">
        <tr>
            ...
            <td style="width: 25%; vertical-align: middle;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($barcode)): ?>
                    <div style="padding: 5px;">
                        ...
                        <br>
                        <span
                            style="font-size: 8px; letter-spacing: 1px; display: block; margin-top: 3px;"><?php echo e($record->do_number); ?></span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
        </tr>
...
</html><?php /**PATH C:\laragon\www\erp-app\resources\views\pdf\delivery-order.blade.php ENDPATH**/ ?>