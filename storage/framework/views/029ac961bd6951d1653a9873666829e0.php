...
<?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="flex flex-col items-end justify-between gap-3 md:items-center md:flex-row" x-data="{ open: false }">
                    ...
                    <div class="p-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->filteredProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                wire:click="$set('selectedProjectId', <?php echo e($project->id); ?>)"
                                @click="open = false"
                                class="w-full flex items-center gap-3 px-3 py-2 rounded-2xl hover:bg-main-light dark:hover:bg-main-dark transition-colors text-left <?php echo e($project->id === $selectedProjectId ? 'bg-main-light dark:bg-main-dark' : ''); ?>"
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->is_pinned): ?>
            ...
            <a href="<?php echo e(url()->previous()); ?>" class="inline-flex items-center w-20 gap-2 px-3 py-2 text-sm font-medium text-black transition-colors rounded-2xl dark:text-white bg-secondary-light hover:bg-main-light dark:bg-secondary-dark ring-1 ring-border-light dark:ring-border-dark dark:hover:bg-main-dark">
                    ...
                    <div class="overflow-hidden border rounded-2xl bg-secondary-light border-border-light dark:bg-secondary-dark dark:border-border-dark">
                        ...
                        >
                            <div class="flex items-center space-x-4">
                                <div>
                                    <h3 class="text-base font-medium text-black dark:text-white"><?php echo e($epic->name); ?></h3>
