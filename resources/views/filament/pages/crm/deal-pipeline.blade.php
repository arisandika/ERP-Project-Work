                        ...
                        <div class="flex flex-col flex-1 gap-3 p-3 overflow-y-auto no-scrollbar"
                            ...
                            @foreach ($stage->deals as $index => $deal)
                                ...
                                <div wire:key="deal-{{ $stage->id }}-{{ $deal->id }}"
                                    class="relative p-3 transition-shadow bg-white border border-l-4 border-gray-200 rounded-lg shadow-sm cursor-move deal-card dark:bg-gray-800 dark:border-gray-700 {{ $borderColor }} hover:shadow-md"
