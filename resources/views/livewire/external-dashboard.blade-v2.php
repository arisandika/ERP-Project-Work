        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div>
                    ...
                    <p class="text-[10px] font-medium mt-2 tracking-wide text-gray-500 uppercase dark:text-gray-400">External Dashboard</p>
                </div>
    ...
    <div class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div class="space-y-6 lg:col-span-4 lg:sticky lg:top-24 h-fit">
                ...
                <h2 class="text-xs font-semibold tracking-wider text-gray-500 uppercase dark:text-gray-400">Overview Project</h2>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1">
                    ...
                    <!-- Card: Progress -->
                    <div class="p-5 transition-colors shadow-sm ring-1 ring-border-light bg-secondary-light rounded-2xl dark:bg-secondary-dark dark:ring-border-dark">
                        <div class="flex items-center justify-between mb-2">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Progress</p>
                            <span class="p-2 text-green-600 bg-green-200 rounded-lg dark:bg-green-900/20 dark:text-green-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                            </span>
                        </div>
                        <div class="flex items-end gap-2">
                            <span class="text-3xl font-bold tracking-tight text-black dark:text-white">{{ $projectStats['progress_percentage'] ?? 0 }}%</span>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 transition-colors shadow-sm ring-1 ring-border-light bg-secondary-light rounded-2xl dark:bg-secondary-dark dark:ring-border-dark">
                            ...
                            <p class="text-2xl font-bold text-black dark:text-white">{{ $projectStats['remaining_days'] ?? '-' }}</p>
                        ...
                        <div class="p-4 transition-colors shadow-sm ring-1 ring-border-light bg-secondary-light rounded-2xl dark:bg-secondary-dark dark:ring-border-dark">
                            ...
                            <p class="text-2xl font-bold text-black dark:text-white">{{ $projectStats['total_tickets'] ?? 0 }}</p>
                ...
                <div class="overflow-hidden transition-colors shadow-sm ring-1 ring-border-light bg-secondary-light rounded-2xl dark:bg-secondary-dark dark:ring-border-dark">
                    ...
                    <div class="p-5 space-y-5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="https://wa.me/{{ preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $project->salesOrder->employee->phone_number)) }}" target="_blank" class="p-2 text-gray-400 transition-colors hover:text-green-500">
                                            ...
                                            <tr class="transition-colors hover:bg-secondary-light dark:hover:bg-secondary-dark">
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    @if ($ticket->description)
                                                        <div
                                                            class="max-w-md mt-1 text-xs text-black truncate dark:text-white">
                                    ...
                                    @forelse($this->tickets as $ticket)
                                        <div
                                            ...
                                            <div class="flex items-start justify-between mb-2">
                                                <span
                                                    class="px-2 py-1 rounded text-[10px] font-bold tracking-wide uppercase bg-gray-100 text-black dark:bg-gray-800 dark:text-white">{{ $ticket->uuid }}</span>
                                                <span
