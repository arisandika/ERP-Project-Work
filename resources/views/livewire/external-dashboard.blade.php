            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 ml-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <p
                                class="text-2xl font-bold {{ $projectStats['progress_percentage'] >= 100 ? 'text-green-600 dark:text-green-400' : ($projectStats['progress_percentage'] >= 75 ? 'text-blue-600 dark:text-blue-400' : ($projectStats['progress_percentage'] >= 50 ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-900 dark:text-white')) }}">
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p
                            class="text-2xl font-bold {{ $projectStats['remaining_days'] !== null && $projectStats['remaining_days'] < 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white' }}">
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm text-gray-900 dark:text-gray-200">
                                                <span
                                                    class="font-medium text-gray-900 dark:text-white">{{ $activity->ticket->name ?? 'Unknown Task' }}</span>
                                                @if ($activity->status)
