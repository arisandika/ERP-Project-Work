...
class PurchaseRequisitionPolicy
{
    ...
    {
        return $user->can('create_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('delete_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('delete_any_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('force_delete_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('force_delete_any_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('restore_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('restore_any_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('replicate_procurement::purchase::requisition');
    }
    ...
    {
        return $user->can('reorder_procurement::purchase::requisition');
    }
}
