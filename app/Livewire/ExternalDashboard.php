...
use App\Models\Project\ExternalAccess;
...
class ExternalDashboard extends Component
{
    ...
    public function refreshData()
    {
        try {
            ...
            // UBAH DARI session()->flash MENJADI $this->dispatch
            $this->dispatch('notify', message: 'Data refreshed successfully!', type: 'success');

        } catch (Exception $e) {
            
            // UBAH DARI session()->flash MENJADI $this->dispatch
            $this->dispatch('notify', message: 'Failed to refresh data. Please try again.', type: 'error');
    ...
    public function loadWidgetData()
    {
        ...
        $this->projectStats = [
            'total_team' => $this->project->employees()->count(),
